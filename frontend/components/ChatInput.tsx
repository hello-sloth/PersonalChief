        ...
        <div className="border-t border-gray-200/50 bg-white/80 p-4">
            ...
            <div className="flex gap-2 items-center">
                ...
                <button
                    ...
                    className="p-2.5 bg-linear-to-r from-orange-500 to-read-500 text-white rounded-xl hover:from-orange-600 hover:to-red-600 disabled:from-gray-300 disabled:to-gray-300 disabled:cursor-not-allowed transition-all shadow-md hover:shadow-lg"
                >
                    <Send size={20}/>
                </button>
            </div>
