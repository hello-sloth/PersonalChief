...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative">
      {/*背景*/}
      <div className="fixed inset-0 bg-linear-to-br from-amber-50 via-orange-50 to-read-50"/>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 p-4">
        <div className="max-w-4xl mx-auto bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold bg-linear-to-r from-orange-600 to-red-600 bg-clip-text text-transparent">AI 私人厨师</h1>
              <p className="text-sm text-gray-500">上传食材图片，获取个性化食谱推荐</p>
            </div>
          </div>
          <button
            onClick={handleNetChat}
          ...
          <div className="flex-1 overflow-y-auto p-4">
            {messages.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-gray-400 mt-3">
                  ...
                  <p className="text-sm mt-2 text-gray-400">我会帮你识别食材并推荐食谱</p>
                </div>
            ): (
