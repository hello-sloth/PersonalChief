            ...
            >
                ...
                <div
                    className={`flex-shrink-0 w-9 h-9 rounded-full flex items-center justify-center shadow-md ${
                        isUser
                            ...
                            : "bg-linear-to-br from-orange-400 to-read-500"
                    }`}
                >
                ...
                <div
                    className={`rounded-2xl px-4 py-3 shadow-sm ${
                        isUser
                            ? "bg-linear-to-br from-blue-50 to-blue-600 text-white"
                    ...
                    {isUser ? (
                        ...
                        <ReactMarkdown
                            ...
                            components={{
                                ...
                                code: ({children}) => <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm font-momo">{children}</code>,
